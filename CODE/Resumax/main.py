...
def parser(pdf):
    ...
    # print("---")
    # print(refs)
    parsed_results = {"titre": replacator(titleStr), "auteur": authors, "mails": mails, "abstract": replacator(abstractStr),
                      "intro": replacator(intro), "body": replacator(bodyText), "discussion": replacator(discussion), "conclusion": replacator(conclu), "biblio": refs}
